...
public class Quiz10 extends javax.swing.JFrame {
   ...
   int ponto10, tempo = 30;
    public Quiz10(int ponto9) {
        initComponents();
        ponto10 = ponto9;
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Qual o menor macaco?");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 210, 30));
        ...
        jLabel4.setText("500 Moedas de Banana");
        ...
        respCorrect.setText("Sagui-Pigmeu");
        ...
        getContentPane().add(respCorrect, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 260, -1, 20));
        ...
        getContentPane().add(o, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, -1, 20));

        ç.setText("Macaco-Prego");
    ...
    private void respCorrectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_respCorrectActionPerformed
        ...
        ResultadoQuiz rq = new ResultadoQuiz(ponto10);
        rq.setVisible(true);
        this.dispose();
